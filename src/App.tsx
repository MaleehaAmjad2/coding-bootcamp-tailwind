    ...
    <div>
      ...
      <section className="bg-gradient-to-r from-[#1B5E20] to-[#2E7D32] py-24 px-5 text-center flex items-center justify-center min-h-[500px]">
        <div className="max-w-[800px]">
          ...
          <Link to="/login" className="inline-block bg-[#1B5E20] text-white px-7 py-3 rounded-lg font-semibold hover:bg-[#2E7D32] hover:-translate-y-0.5 transition-all">Get Started</Link>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-[#1B5E20] to-[#2E7D32] py-20 px-5 text-center">
        <div className="max-w-[700px] mx-auto">
          ...
          <Link to="/login" className="inline-block bg-[#1B5E20] text-white px-7 py-3 rounded-lg font-semibold hover:bg-[#2E7D32] transition-all">Enroll Today</Link>
        </div>
      </section>
    </div>
  );
